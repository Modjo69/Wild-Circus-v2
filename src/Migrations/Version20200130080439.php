 ...
 */
final class Version20200130080439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps CHANGE picture picture VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apps CHANGE picture picture VARCHAR(505) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
